...
public class CommandContainer {
    ...
    public CommandContainer(SendBotMessageService sendBotMessageService, CartService cartService,
        ...
        commandMap = ImmutableMap.<String, CrazyCookTGCommand>builder()
                ...
                .put(ADD_BOX.getCommandName(), new AddBoxCommand(sendBotMessageService, cartService, boxService))
                ...
                .put(CHOOSE_FLAVORS.getCommandName(), new ChooseFlavorsCommand(sendBotMessageService, flavorService, cartService))
                ...
                .put(FLAVOR_ID.getCommandName(), new FlavorIdCommand(sendBotMessageService, flavorService, cartService, boxService, flavorQuantityService))
                ...
                .put(COMPLETE_CART.getCommandName(), new CompleteCartCommand(sendBotMessageService, customerService, cartService, adminService, orderService))
